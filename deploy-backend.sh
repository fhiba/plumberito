...
gcloud run deploy orchestrator \
  ...
  --set-env-vars "LLM_MODEL=${LLM_MODEL:-google/gemini-2.0-flash-001},WEBHOOK_LLM_MODEL=${WEBHOOK_LLM_MODEL:-deepseek/deepseek-chat},GITHUB_ORG=${GITHUB_ORG:-plumberito},GCP_PROJECT=${GCP_PROJECT},GCP_REGION=${GCP_REGION:-us-central1},GCP_PROJECT_NUMBER=${GCP_PROJECT_NUMBER},WIF_PROVIDER=${WIF_PROVIDER},FIREBASE_SA_EMAIL=${FIREBASE_SA_EMAIL}" \
